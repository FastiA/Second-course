.ALIASES
X_U1            U1(G1bar=$D_LO G2bar=$D_LO A=HEEL B=N00470 C=N00432 D=N00444 Y0=OUT1 Y1=OUT2 Y2=OUT3 Y3=OUT4 Y4=OUT5 Y5=OUT6
...
X_U2            U2(CKA=N03656 CKB=HEEL R01=$D_LO R02=$D_LO QA=HEEL QB=N00470 QC=N00432 QD=N00444 VCC=$G_DPWR GND=$G_DGND ) CN
+@FIRST.System_Decoder(sch_1):INS280@7400.7493A.Normal(chips)
_    B1(RESET=N033100 Folk1=N03656 Folk2=FCLK2 ) CN @FIRST.System_Decoder(sch_1):B1@FIRST.OSC(sch_1)
X_B1_B1U1          B1.B1U1(CKA=N03656 CKB=M_UN0001 R01=N033100 R02=N033100 QA=FCLK2 QB=M_UN0002 QC=M_UN0003 QD=M_UN0004
+VCC=$G_DPWR GND=$G_DGND ) CN @FIRST.System_Decoder(sch_1):B1@FIRST.OSC(sch_1):INS60@7400.7493A.Normal(chips)
X_B1_B1U2A          B1.B1U2A(A=N033100 Y=B1_N00450 VCC=$G_DPWR GND=$G_DGND ) CN
...
_    _(B1.Folk1=N03656)
_    _(B1.Folk2=FCLK2)
_    _(B1.RESET=N033100)
U_DSTM1          DSTM1(VCC=$G_DPWR GND=$G_DGND OUT=N033100 ) CN
+@FIRST.System_Decoder(sch_1):INS3768@SOURCSTM.DigStim1.Normal(chips)
_    _(FCLK2=FCLK2)
_    _(Heel=HEEL)
_    _(OUT1=OUT1)
_    _(OUT10=OUT10)
